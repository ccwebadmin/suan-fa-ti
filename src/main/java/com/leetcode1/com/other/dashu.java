...
public class dashu {
    public static void main(String[] args) {
        ...
        BigDecimal num1 = new BigDecimal(110.005);
        BigDecimal num2 = new BigDecimal(1000000);
        BigDecimal num3 = new BigDecimal(-1000000);
        //尽量用字符串的形式初始化
        BigDecimal num12 = new BigDecimal("110.005");
        ...
        //除法
        BigDecimal result5 = num2.divide(num1,4,BigDecimal.ROUND_UP);
        BigDecimal result52 = num22.divide(num12,4,BigDecimal.ROUND_UP);
