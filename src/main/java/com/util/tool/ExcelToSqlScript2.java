...
public class ExcelToSqlScript2 {


    public static void main(String[] args) {
        String excelFilePath = "C:\\Users\\Lenovo\\Desktop\\mbs\\2.xlsx";
        String sqlFilePath = "C:\\Users\\Lenovo\\Desktop\\mbs\\医保业务基础子系统-待遇-菜单SQL脚本.sql";
        ...
        try {
            ...
            for (int i = 1; i < sheet.getPhysicalNumberOfRows(); i++) {
                ...
                // 根目录
                if (i == 1) {
                    writeSqlToFile(fos, generateMenuSql("b8b4f22843934879a045268ab8af22fe", "-1", "医保业务基础子系统-待遇", "ybywjczxy-dy", "/#/", 1,"0"));
                    writeSqlToFile(fos, generatePermissionSql("医保业务基础子系统-待遇", "b8b4f22843934879a045268ab8af22fe"));
                    writeSqlToFile(fos, generateBasicFunctionSql("医保业务基础子系统-待遇", generateRandomId(), "b8b4f22843934879a045268ab8af22fe"));
                }
